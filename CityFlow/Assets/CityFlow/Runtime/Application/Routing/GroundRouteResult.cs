...
{
    public sealed class GroundRouteResult
    {
        ...
        public GroundRouteResult(LineRoute route) { Route = route ?? throw new ArgumentNullException(nameof(route)); InvalidSegment = -1; }
        public GroundRouteResult(RouteFailure failure, int invalidSegment = -1)
        {
