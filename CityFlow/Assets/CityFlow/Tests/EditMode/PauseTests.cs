...
namespace CityFlow.Tests.EditMode
{
    public sealed class PauseTests
    {
        ...
        {
            var n=new FlowNetwork(Stage(),new NetworkSettings(2,2,10,0)); var random=new First(); var s=new FlowSimulation(n,random);
        ...
        {
            var stage=Stage(); var n=new FlowNetwork(stage,new NetworkSettings(20,2,10,0)); var s=new FlowSimulation(n,new First());
        ...
        {
            var n=new FlowNetwork(Stage(),new NetworkSettings(20,2,10,0)); var s=new FlowSimulation(n,new First());
            n.TryConnect("S","T",new[]{Vector3.zero,new Vector3(20,0,0)}); n.GenerateFlow("S",FlowColor.Red); s.Tick(0.3);
